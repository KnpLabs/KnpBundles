 ...
 */
class frontDevDebugProjectContainer extends Container
{
    ...
    protected function getRouterService()
    {
        ...
        $instance = new $class(array(0 => $this->get('kernel'), 1 => 'registerRoutes'), array('cache_dir' => '/home/thib/data/workspace/symfony2bundles/front/cache/dev', 'debug' => true, 'matcher_cache_class' => 'front'.'UrlMatcher', 'generator_cache_class' => 'front'.'UrlGenerator'));
    ...
    protected function getTemplating_Loader_FilesystemService()
    {
        ...
        $instance = new $class(array(0 => '/home/thib/data/workspace/symfony2bundles/front/views/%bundle%/%controller%/%name%%format%.%renderer%', 1 => '/home/thib/data/workspace/symfony2bundles/front/../src/Application/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%', 2 => '/home/thib/data/workspace/symfony2bundles/front/../src/Bundle/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%', 3 => '/home/thib/data/workspace/symfony2bundles/front/../src/vendor/Symfony/src/Symfony/Framework/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%'));
    ...
    protected function getProfiler_StorageService()
    {
        ...
        $instance = new $class('/home/thib/data/workspace/symfony2bundles/front/cache/dev/profiler.db', NULL, 86400);
    ...
    protected function getZend_Logger_Writer_FilesystemService()
    {
        ...
        $instance = new $class('/home/thib/data/workspace/symfony2bundles/front/logs/dev.log');
...
');
  ...
  array (
    ...
    {
        return array(
            'kernel.root_dir' => '/home/thib/data/workspace/symfony2bundles/front',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'front',
            'kernel.cache_dir' => '/home/thib/data/workspace/symfony2bundles/front/cache/dev',
            'kernel.logs_dir' => '/home/thib/data/workspace/symfony2bundles/front/logs',
            'kernel.bundle_dirs' => array(
                'Application' => '/home/thib/data/workspace/symfony2bundles/front/../src/Application',
                'Bundle' => '/home/thib/data/workspace/symfony2bundles/front/../src/Bundle',
                'Symfony\\Framework' => '/home/thib/data/workspace/symfony2bundles/front/../src/vendor/Symfony/src/Symfony/Framework',
            ),
            'kernel.bundles' => array(
                ...
                3 => 'Application\\FrontBundle\\FrontBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'templating.loader.filesystem.path' => array(
                0 => '/home/thib/data/workspace/symfony2bundles/front/views/%bundle%/%controller%/%name%%format%.%renderer%',
                1 => '/home/thib/data/workspace/symfony2bundles/front/../src/Application/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
                2 => '/home/thib/data/workspace/symfony2bundles/front/../src/Bundle/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
                3 => '/home/thib/data/workspace/symfony2bundles/front/../src/vendor/Symfony/src/Symfony/Framework/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
            ),
            ...
            'profiler.storage.file' => '/home/thib/data/workspace/symfony2bundles/front/cache/dev/profiler.db',
...
',
            'zend.logger.path' => '/home/thib/data/workspace/symfony2bundles/front/logs/dev.log',
        );
    }
}
