...
class RepoTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @test
     */
    public function isValidSymfonyBundle_shouldReturn_TRUE_IfRepoHasCorrectBundleClass()
    {
     ...
     * @test
     */
    public function isValidSymfonyBundle_shouldReturn_FALSE_IfRepoDoesNotHaveBundleClass()
    {
        $bundle = new Bundle('knplabs/KnpMenuBundle');
     ...
     * @test
     */
    public function isValidSymfonyBundle_shouldReturn_FALSE_IfRepoHasIncorrectBundleClass()
    {
        $bundle = new Bundle('knplabs/KnpMenuBundle');
